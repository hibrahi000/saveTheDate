...
const initialState = {
  ...
  /**
   * Proposal photo (cruise) — drop the file at /public/proposal.jpg (or .png/.webp)
   * and set this to the path to render the section. Set to null to hide the section.
   */
  proposalPhoto: {
    src:        null,             // e.g. '/proposal.jpg' once the file is added
  ...
  heroBackdropSrc: '/ashton_garden_backdrop.jpg',
};
